...
public class ShowTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Check_connectivity check = new Check_connectivity(ShowTest.this);
        if(check.getInternetStatus())
        {
            ...
            Toast.makeText(ShowTest.this,"Internet Connection Problem",Toast.LENGTH_LONG).show();
        }
    ...
    private class DisplayTask extends AsyncTask<String,Void,String> {
        ...
        ProgressDialog pd = new ProgressDialog(ShowTest.this);
        ...
        protected void onPostExecute(String jsonData) {
            ...
            try {
                ...
                DisplayTest_adapter adapter = new DisplayTest_adapter(data,ShowTest.this);
                recyclerView.setAdapter(adapter);
                recyclerView.setLayoutManager(new LinearLayoutManager(ShowTest.this));



            } catch (JSONException e) {
                e.printStackTrace();
                Toast.makeText(ShowTest.this,"Unable to fetch Data",Toast.LENGTH_SHORT).show();
            }catch (Exception e){
                e.printStackTrace();
                Toast.makeText(ShowTest.this,"Unable to connect",Toast.LENGTH_SHORT).show();
            }
